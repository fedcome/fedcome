...
class client(client):
    ...
    def train(self, server_parameters, round_idx):
        ...
        for i in range(epoch):
            ...
            if (self.args.batch_mode):
                break
        self.last_grad = self.get_model_params_vector() - init
        self.last_round = round_idx



        return (len(self.train_data), (self.get_model_params_vector() - init).cpu(), ret_loss)
